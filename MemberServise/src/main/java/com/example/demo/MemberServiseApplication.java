...
public class MemberServiseApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		membreService.affect_EtudianToEnseignant(etudiant1.getId(), enseignant1.getId());
		membreService.affect_EtudianToEnseignant(etudiant2.getId(), enseignant1.getId());
		List<Etudiant> etds = membreService.findByEncadrant(enseignant1);
